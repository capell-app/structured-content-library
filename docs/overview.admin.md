...
Usually no. It works automatically once installed. You will see its effect in the content types other packages offer, not in a screen of its own.

## Where it shows up

Inside other packages that build on its shared content types.
